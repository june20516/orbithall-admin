...
import { CorsOriginInput } from "@/components/CorsOriginInput";
          ...
          <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-zinc-900 dark:text-zinc-50">{site.domain}</p>
              </div>
        ...
        {showDeleteConfirm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="w-full max-w-md rounded-lg bg-white p-6 dark:bg-zinc-900">
              ...
              <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                이 작업은 되돌릴 수 없습니다. <strong>{site.name}</strong>과(와) 연관된 모든 게시글, 댓글이 영구적으로 삭제됩니다.
              </p>
